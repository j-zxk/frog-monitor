import { ErrorTypes, EventTypes, WxAppEvents, WxPageEvents } from 'frog-monitor-shared';
import { InitOptions, ReportDataType } from 'frog-monitor-types';
import { getLocationHref, getTimestamp, setFlag, Severity } from 'frog-monitor-utils';
